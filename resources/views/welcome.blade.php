    ...
    <body>
        ...
        <main class="text-center">
            <form action="" class="">
                <div class="">
                    <label for="search">
                        <input type="search" placeholder="search for a fleet" class="rounded">
                    </label>
                </div>
                ...
                <div class="">
                    ...
                    <h3>Filter by <span>All location</span></h3>
                    <div class="m-5">
                        <label for="work_category">
                            <select name="work_category" id="work_category">
                                <option value="">Entaintement, Event or sports</option>
                                <option value="">Mechanical Engineering</option>
                                <option value="">Plumbing works</option>
                                <option value="">Electrical Engineering</option>
                                <option value="">Agricult and fishing and forestry</option>
                        ...
                        <label for="location">
                            <select name="location" id="location">
                                <option value="">Across Ghana</option>
                                <option value="">Accra - Tema</option>
                                <option value="">Kumasi - Ashanti</option>
                                <option value="">Takoradi - Western</option>
                                <option value="">Tamale - Notern</option>
                            </select>
                        </label>

                        <button class="py-2 px-5 bg-blue-600 text-white rounded text-sm">Filter</button>
                    </div>
